...
class semaphore {
    ...
    void dump(int level); // include some functions which will allow you to dump the contents of the semaphore in a readable format. See the expected output section (below) for suggestions.
};